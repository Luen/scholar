#!/usr/bin/env python3
"""Orchestrate scholar data fetch: author, coauthors, publications, DOI, impact factor."""
...
def main() -> None:
    setup_logging()
    p = argparse.ArgumentParser(description="Full Google Scholar scrape for one author ID.")
